...
window.BaseProjection = BaseProjection;
window.PerspectiveProjection = PerspectiveProjection;
window.OrthographicProjection = OrthographicProjection;
window.StereographicProjection = StereographicProjection;
