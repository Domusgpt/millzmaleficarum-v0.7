...
window.BaseGeometry = BaseGeometry;
window.HypercubeGeometry = HypercubeGeometry;
window.HypersphereGeometry = HypersphereGeometry;
window.HypertetrahedronGeometry = HypertetrahedronGeometry;
